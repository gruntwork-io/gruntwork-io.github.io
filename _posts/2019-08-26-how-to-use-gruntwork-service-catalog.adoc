...
Now that you know _how_ to use `gruntwork-install`, let's talk about _where_ to use it.

==== Where to run gruntwork-install
...
[[gruntwork_install_packer]]
===== Running gruntwork-install in Packer templates
...
[[gruntwork_install_docker]]
===== Running gruntwork-install in Docker images
