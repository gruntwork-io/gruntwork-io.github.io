...
|https://github.com/gruntwork-io/terraform-aws-cis-service-catalog/releases/tag/TBD[TBD]
...
|terraform-aws-nomad
|https://github.com/hashicorp/terraform-aws-nomad/releases/tag/TBD[TBD]

|terraform-aws-architecture-catalog
|https://github.com/gruntwork-io/terraform-aws-architecture-catalog/releases/tag/TBD[TBD]

|terraform-aws-service-catalog
|https://github.com/gruntwork-io/terraform-aws-service-catalog/releases/tag/TBD[TBD]
