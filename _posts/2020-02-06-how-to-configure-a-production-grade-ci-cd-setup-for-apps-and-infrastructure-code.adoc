...
https://jenkins.io/[Jenkins] (self-hosted, generic)::
  ...
  corporate network over VPN, as well as by keeping the server frequently patched. This does mean that you shouldn't
...
deployments will have de factor admin status to the environments that you are deploying into. As such, it is important
