...
|cis-compliance-aws
|https://github.com/gruntwork-io/cis-compliance-aws/releases/tag/v0.9.3[v0.9.3]
|3.10, 3.11, 4.15, 5.1
...
module "vpc_app_network_acls" {
  source = "git::git@github.com:gruntwork-io/cis-compliance-aws.git//modules/vpc-app-network-acls?ref=v0.10.0"
...
https://github.com/gruntwork-io/cis-compliance-aws/tree/v0.9.3/modules/vpc-app-network-acls#calculating-nacl-rules-limits[our
