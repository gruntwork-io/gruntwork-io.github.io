...
. Now ensure the module is updated to the same version used in Reference Architecture version
...
====
    ...
    * Find <<service_migration_guides,the dedicated service migration guide>> for the service.
