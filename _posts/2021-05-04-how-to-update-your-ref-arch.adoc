...
. Validate the configuration with `terragrunt validate-inputs`.
...
. If the service has downstream dependencies, run `terragrunt validate-all` at the ACCOUNT folder level to identify any
...
* link:./refarch2-guides/cloudwatch-dashboard.adoc[cloudwatch-dashboard Service Migration Guide]
...
* link:./refarch2-guides/ecs-service-with-alb.adoc[ecs-service-with-alb Service Migration Guide]
...
* link:./refarch2-guides/iam-user-password-policy.adoc[iam-user-password-policy Service Migration Guide]
...
* link:./refarch2-guides/vpc-app.adoc[VPC (app) Migration Guide]
