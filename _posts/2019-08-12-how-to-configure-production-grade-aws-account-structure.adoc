...
using the "Forgot your password?" prompt on the login page. AWS will email you a reset link, which you can click to go
to a page that will allow you to configure a password for the root user.
