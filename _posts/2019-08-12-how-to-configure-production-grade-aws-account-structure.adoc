...
AWS Config, AWS CloudTrail, Amazon Guard Duty, IAM users, IAM groups, IAM password policy, and more. We create a handful of IAM groups including a `full-access`
...
accounts as fully detailed in the <<child_accounts> section, but feel free to adjust this as necessary based on
