---
title: How to update to Terraform 0.13
categories: Upgrades
...
the proper versions of the Gruntwork library to pick up the fixes/changes that were made to be compatible. **You MUST
follow the migration instructions (if any) in the release notes in each repo to know what changes need to be made to
...
Repo,Status,Priority,Owner,Version,Module changes,Notes
|Terratest
