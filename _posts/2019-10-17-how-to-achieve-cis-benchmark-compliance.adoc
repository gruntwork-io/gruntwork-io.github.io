...
NOTE: Previously, we supported version 1.3.0 and 1.2.0 of the Benchmark. If you are looking to upgrade from an older version please follow these in order:
* from v1.2.0 to v.1.3.0, please follow link:/guides/upgrades/how-to-update-to-cis-13/[the upgrade guide];
* from v1.3.0 to v1.4.0, please follow link:/guides/upgrades/how-to-update-to-cis-14/[the upgrade guide].
...
[[protect_your_s3_data]]
==== Protect your S3 Data
The CIS 1.4.0 Benchmark recommend a few additional steps to ensure your data is secured and accessible. The two recommendations relate both to S3 and prescribe that the MFA Delete is enabled on all S3 buckets in your accounts (2.1.3) and that all data in your S3 buckets is classified, discoverable and secured using Amazon Macie. You'll be able to find more details on how to enable these in link:/guides/upgrades/how-to-update-to-cis-14/[the migration guide to CIS 1.4.0].
...
NOTE: This is not the full list of steps needed to configure Amazon Macie for your account. To follow the steps necessary
to configure it according to the CIS 1.4.0 Benchmark, please follow the Macie section in the
