...
please follow link:https://gruntwork.io/guides/upgrades/how-to-update-to-cis-13/[the upgrade guide] instead.
...
Recommendation 5.2 forbids allowing ports 22 (SSH) and 3389 (Remote Desktop) from the public Internet
...
* you can do so manually using the AWS CLI or the AWS web console. For more guidance on how to do so, please refer to
link:https://docs.aws.amazon.com/IAM/latest/UserGuide/what-is-access-analyzer.html[the official AWS docs];
* you can also use the examples provided as part of `learning-and-testing/landingzone`:
...
TODO(Marina): Add instructions for 5.1.
