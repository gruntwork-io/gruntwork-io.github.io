...
To help you achieve this recommendation, we've created a Lambda function that runs on a regular schedule and
...
For the standalone module available as part of the Gruntwork module library and Service Catalog, have a read here:
