...
NOTE: Previously, we supported version 1.3.0 of the Benchmark. If you are looking to upgrade from v1.3.0 to v1.4.0,
please follow link:/guides/upgrades/how-to-update-to-cis-14/[the upgrade guide] instead.
