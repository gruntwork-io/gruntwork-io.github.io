...
inputs = {
  ...
  # Set this to false because this is the account to aggregate Config data
  config_aggregate_config_data_in_external_account = false
  config_central_account_id                        = null

  # The bucket was created by account-baseline-root in this account
  ...
  # Set to false because both S3 bucket and KMS key were created in this account by account-baseline-root
  cloudtrail_s3_bucket_already_exists = true
  cloudtrail_kms_key_already_exists = true
